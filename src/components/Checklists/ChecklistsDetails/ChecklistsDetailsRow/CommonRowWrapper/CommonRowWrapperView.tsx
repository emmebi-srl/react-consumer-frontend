...
export const StyledItem = /* TODO: interpolation requires manual refactor */
styled(List.Item)(() => ({ /* FIXME convert from template */
${CardPadding}
}))
const StyledComponentCnt = styled('div')({margin: 5px 0;})
const EmployeeIndicationsCnt = styled('div')({margin-top: 5px;})
