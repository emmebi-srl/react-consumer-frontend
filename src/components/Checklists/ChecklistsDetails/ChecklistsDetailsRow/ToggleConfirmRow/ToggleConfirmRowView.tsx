...
const StyledRadio = styled(Radio)({margin-right: 5%;})

const NotesContainer = styled(Form)({display: inline-block;
  width: 50%;})
const Group = styled('div')({width: 50%;
  display: inline-block;})

const QuantityContainer = styled(Form)({display: inline-block;
  max-width: 40%!important;
  margin-left: 30px;})
const FormField = styled(Form.Field)({display: inline-block;
  width: 40%;
