...
export const RouteConfig = {
  ...
  QuoteRevisionEdit: defineRoute('quotes/:year/:quoteId/revisions/:revisionId/edit'),
  QuoteLotNew: defineRoute('quotes/:year/:quoteId/revisions/:revisionId/lots/new'),
  QuoteLotEdit: defineRoute('quotes/:year/:quoteId/revisions/:revisionId/lots/:lotPosition/edit'),
  ReportList: defineRoute('reports'),
  ReportNew: defineRoute('reports/new'),
  ReportFromMobile: defineRoute('reports/from-mobile'),
  ReportEdit: defineRoute('reports/:year/:reportId/edit'),
