...
const DesktopSeparator = /* TODO: interpolation requires manual refactor */
...
const TabletSeparator = /* TODO: interpolation requires manual refactor */
styled(DesktopSeparator)(() => ({ /* FIXME convert from template */
display: none;
  ${media.tablet
}))
    display: inline-block;
...
const OnlyTabletSeparator = /* TODO: interpolation requires manual refactor */
styled(DesktopSeparator)(() => ({ /* FIXME convert from template */
display: none;
  ${media.tablet
}))
